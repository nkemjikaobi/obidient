...
const UtilityTokenBalance = () => {
  return (
    <div className="border rounded-[7px] border-obiGray-320">
      <h4 className="text-18 mt-[31px] mb-[6px] text-center whitespace-nowrap">Utility Token Balance </h4>
      <h4 className="text-[40px] font-medium mb-[5px] text-center whitespace-nowrap">21.226 LPO </h4>

...
const MembershipPlan = () => {
  return (
    <div className="bg-white px-[34px] pt-[44px] rounded-[20px] w-[480px] pb-8">
      ...
      <CustomButton
        customClass="!rounded-[5px] !border-obiGray-100 !text-obiGray-350 !bg-obiGray-100 hover:!bg-obiGray-250 !my-6 !w-full"
        handleClick={() => {}}

    ...
    <div className="bg-white px-6 smallLaptop:px-[34px] pt-[44px] rounded-[20px] smallLaptop:w-[380px] television:w-[480px] smallLaptop:h-[513.88px] bigLaptop:pb-8">
      ...
      <div className="border border-obiBlue-300 px-[28px] pt-[29px] w-[311px] television:w-[411px]">
        <div className="flex items-center justify-between">
          <p className="text-12 smallLaptop:text-14 text-obiGray-320">Monthly</p>
          <div className="flex justify-center items-center text-obiGreen-400 rounded-[5px] bg-green-100 text-8 smallLaptop:text-10 w-[67px] h-[31px] font-semibold">Active</div>
        </div>
        ...
        <p className="text-12 smallLaptop:text-14 text-obiGray-320 mt-[33px] mb-[36px]">Expires on the 25th of January 2023</p>
      </div>
      <CustomButton
